...
// var shuffleSequence = seq("setcounter","consent","instructions","scaleinstr","distract", randomize("Claim"), "debrief","send","thanks");
...
// );
 ...
 PennController.Template( "ListTotal.csv", // No need to setGroup: columns named "Group" are automatically detected as such
  ...
  ,
    ...
    ,   
        ...
        .settings.css("border", "solid 1px green")
              ...
              .settings.add(380,130, newText("labeRight", "volkommen nat&uuml;rlich an").settings.bold() )
